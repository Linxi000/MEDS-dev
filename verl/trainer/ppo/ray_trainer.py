...
def compute_advantage(
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        if "cluster_size_per_sample" in data.non_tensor_batch:  # optional, for grpo_cluster
            adv_kwargs["cluster_size_per_sample"] = data.non_tensor_batch["cluster_size_per_sample"]
        if "cluster_penalty_correctness" in data.non_tensor_batch:
            adv_kwargs["cluster_penalty_correctness"] = data.non_tensor_batch["cluster_penalty_correctness"]
