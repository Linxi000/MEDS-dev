...
# 0
exp_name='cluster-debug'

# 1 改成相应的处理函数
adv_estimator=grpo_cluster_score_minlog_both
# 2 改成相应的hdbscan版本
cluster_method="hdbscan_knn_random"
...
TRAIN_FILE=${TRAIN_FILE:-"/inspire/hdd/project/exploration-topic/public/bwang/exwang/data/unified_math_100_new.parquet"}
