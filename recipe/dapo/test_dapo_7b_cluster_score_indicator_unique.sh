...
exp_name='cluster-score-answer_token-logits_indicator_penalty0.1_unique'

adv_estimator=grpo_cluster_score_indicator
...
TRAIN_FILE=${TRAIN_FILE:-"${HOME}/data/unified_math_25k_new_unique.parquet"}
