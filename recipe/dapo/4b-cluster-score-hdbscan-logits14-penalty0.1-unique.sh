...
# 0
exp_name='4b-cluster-score-hdbscan-logits14-penalty0.1-unique'
...
MODEL_PATH=${MODEL_PATH:-"/inspire/hdd/project/exploration-topic/public/bwang/models/Qwen3-4B-Base"}
